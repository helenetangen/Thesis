...
\noindent In this project, it is investigated if population distributed genetic algorithms are able to solve the wind farm layout optimization problem better than traditional non-population distributed genetic algorithms. This project is a contribution to a wind farm layout optimization contest launched by the Genetic and Evolutionary Computation Conference (GECCO) 2016. The project will become part of an open source library that can contribute to further investigation and research within wind farm layout optimization with genetic algorithms.\\
