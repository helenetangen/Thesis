...
The models are tested on 4 different wind scenarios provided by GECCO 2016 as shown in table \ref{table:scenario properties}. As can be seen, the first two scenarios contain obstacles and the last two do not. \\
