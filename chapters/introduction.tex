...
\noindent This chapter provides an introduction to the thesis. Section \ref{section:motivation&background} contains the background and motivation behind the thesis, section \ref{section:goal&researchquestions} introduces the goal and research questions that will be investigated, and section \ref{thesisstructure} gives an overview of the thesis structure. \\
