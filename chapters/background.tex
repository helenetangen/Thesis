...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth, height=4cm]{images/"population distributed genetic algorithms"/"island-master-slave hybrid"}
        \caption{}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth, height=4cm]{images/"population distributed genetic algorithms"/"island-cellular hybrid model"}
        \caption{}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth, height=4cm]{images/"population distributed genetic algorithms"/"island-island hybrid model"}
        \caption{}
    \end{subfigure}
